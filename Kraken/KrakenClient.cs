...
namespace Kraken
{
    ...
    public class KrakenClient
    {
        ...
        private void Warn()
        {
            Console.WriteLine("vous ne pouvez qu'acceder aux API public car vous n'avez pas renseigné vos clefs et votre niveau de certification");
        }

        public JsonObject QueryPublic(string a_sMethod, string props=null)
        {
            string address = string.Format("{0}/{1}/public/{2}", _url, _version, a_sMethod);
            //Console.Out.WriteLine("{0} : POST {1}", DateTime.UtcNow.ToLongTimeString(), address);
            ...
            try
            {
                ...
                DateTime avant = DateTime.UtcNow;
                using (WebResponse webResponse = webRequest.GetResponse())
                {
                    //Console.Out.WriteLine("temps d'execution de la requete : {0}ms", DateTime.UtcNow.Subtract(avant).TotalMilliseconds);
        ...
        public JsonObject QueryPrivate(string a_sMethod, ushort poids, string props = null)
        {
            if (publicOnly)
            {
                Warn();
            ...
            {
                //Wait for RateGate
                ddosProtection.WaitToProceed(poids);
        ...
        // Get a internal list of active assets and their properties:
        /** 
        ...
        */
        ...
        //Get a internal list of tradable asset pairs
        public JsonObject GetAssetPairs(List<string> pairs = null)
        {
        ...
        // Get internal ticker info for BTC/USD pair:
        /**
         * Example output:
         *
         * Array
        ...
        {
            return QueryPrivate("Balance", 1) as JsonObject;
        }
        ...
        public JsonObject GetTradeBalance(string aclass, string asset)
        {
            ...
            return QueryPrivate("TradeBalance", 2, reqs);
        }
        ...
        public JsonObject GetClosedOrders(bool trades=false, string userref="",string start="",string end="",string ofs="", string closetime="both")
        {
            ...
            return QueryPrivate("ClosedOrders", 1, reqs) as JsonObject;
        }
        ...
        public JsonObject QueryOrders(string txid, bool trades = false, string userref = "")
        {
            ...
            return QueryPrivate("QueryOrders", 1, reqs) as JsonObject;
        }
        ...
        public JsonObject GetTradesHistory(string ofs="", string type="all", bool trades = false, string start = "", string end="")
        {
            ...
            if (!string.IsNullOrEmpty(end))
                reqs += string.Format("&end={0}", end);
            return QueryPrivate("TradesHistory", 2, reqs) as JsonObject;
        }
        ...
        {
            string reqs = string.Format("&txid={0}&trades={1}", txid, trades);
            return QueryPrivate("QueryTrades", 2, reqs) as JsonObject;
        }
        ...
        public JsonObject GetOpenPositions(string txid = "", bool docalcs = false)
        {
            ...
            return QueryPrivate("OpenPositions", 1, reqs) as JsonObject;
        }
        ...
        public JsonObject GetLedgers(string aclass = "currency", string asset = "all", string type = "all", string start = "", string end = "", string ofs = "")
        {
            ...
            if (!string.IsNullOrEmpty(end))
                reqs += string.Format("&end={0}", end);
            return QueryPrivate("Ledgers", 2, reqs) as JsonObject;  
        }
        ...
        public JsonObject QueryLedgers(string id = "")
        {
            ...
            return QueryPrivate("QueryLedgers", 2, reqs) as JsonObject;
        }
        ...
        {
            string reqs = string.Format("&pair={0}", pair);
            return QueryPrivate("TradeVolume", 2, reqs) as JsonObject;
        }
            ...
            Dictionary<string, string> close = null)
        {
            ...
            return QueryPrivate("AddOrder", 0, reqs) as JsonObject;
        }
        ...
        public JsonObject CancelOrder(string txid)
        {
            ...
            return QueryPrivate("CancelOrder", 0, reqs);
        }
